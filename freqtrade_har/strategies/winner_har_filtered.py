"""
Winner: Volatility Breakout — HAR Filtered (B)
...
HAR variant: B (skip HIGH regime entries).
...
class WinnerHARFiltered(IStrategy):
    """
    ...
    def populate_entry_trend(
        ...
        # During backtesting the DB is unavailable and
        # the filter is bypassed automatically.
        regime_ok = True
        if HAR_AVAILABLE:
            try:
