...
def test_1_buy_and_hold():
    ...
    pf = vbt.Portfolio.from_signals(close, entries, exits, freq="1h", init_cash=10000.0, fees=0.001, slippage=0.001, size_type="percent", upon_opposite_entry="Ignore")
...
def test_3_alternating_signal():
    ...
    pf = vbt.Portfolio.from_signals(close, entries, exits, freq="1h", init_cash=10000.0, fees=0.0, slippage=0.0, size_type="percent", upon_opposite_entry="Ignore")
...
def test_signal_alignment():
    ...
    pf = vbt.Portfolio.from_signals(close, entries, exits, freq="1h", fees=0.0, slippage=0.0, size_type="percent", upon_opposite_entry="Ignore")
